...
const TeamPopup = ({ popupOpen, setPopupOpen, editingId, popup, onSuccess }) => {
  ...
  const onSubmitHandler = (e) => {
    ...
    // Filter out any undefined/null members and extract just the user IDs
    const memberIds = form.members
      .filter(member => member && member.user) // Remove undefined/null members
      .map(member => member.user); // Extract user IDs
