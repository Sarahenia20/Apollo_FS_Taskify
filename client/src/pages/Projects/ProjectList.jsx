...
const ProjectList = () => {
  ...
  // Add this after fetchProjects function
  const fetchUsers = async () => {
    try {
      const response = await axios.get("/api/users");
      // Filter users to get only those with manager roles
  ...
  // Modify useEffect to fetch both projects and users
  useEffect(() => {
    fetchProjects();
    fetchUsers();
  }, []);
  ...
  // Add filtered projects computation
