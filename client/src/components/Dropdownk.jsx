...
const DropdownDefault = (props) => {
  ...
  // Get the current task data from Redux store
  ...
  const handleEditClick = () => {
    dispatch(FindOneTaskAction(props._id)).then(() => {
      setPopupOpen(true);
    });
  };
  ...
  return (
    <div className="relative">
      ...
      <TaskPopup
        ...
        popup={popup}
        taskData={currentTask} // Pass the current task data
        isEditMode={true} // Indicate this is an edit operation
      />
      <CommentPopup
  popupOpen={popupOpenComment}
  setPopupOpen={setPopupOpenComment}
  popup={popupComment}
  taskId={props._id} // Pass the task ID
/>
    </div>
  );
};
