import {
  ...
  memoizeOne
} from "./chunk-JZTZNP5H.js";
import {
  require_prop_types
} from "./chunk-JNOVHZGD.js";
import {
  _defineProperty,
  _objectSpread2,
  _typeof
...
function _format(localizer, formatter, value, format2, culture) {
  var result = typeof format2 === "function" ? format2(value, culture, localizer) : formatter.call(localizer, value, format2, culture);
  ...
  function DayColumn2() {
    ...
    _this.renderEvents = function(_ref) {
      ...
      return styledEvents.map(function(_ref2, idx) {
        ...
        if (startsBeforeDay)
          format2 = "eventTimeRangeEndFormat";
        else if (startsAfterDay)
          format2 = "eventTimeRangeStartFormat";
...
var TimeGrid = function(_Component) {
  ...
  _createClass(TimeGrid2, [{
    ...
    value: function renderEvents(range3, events, backgroundEvents, now) {
      var _this2 = this;
      var _this$props = this.props, min3 = _this$props.min, max3 = _this$props.max, components2 = _this$props.components, accessors = _this$props.accessors, localizer = _this$props.localizer, dayLayoutAlgorithm = _this$props.dayLayoutAlgorithm;
...
function moment(moment2) {
  ...
  return new DateLocalizer({
    ...
    format: function format2(value, _format2, culture) {
...
function luxon(DateTime) {
  ...
  function formatDate(value, format2) {
    return DateTime.fromJSDate(value).toFormat(format2);
  }
  function formatDateWithCulture(value, culture, format2) {
    return DateTime.fromJSDate(value).setLocale(culture).toFormat(format2);
  }
  function defineComparators(a, b, unit) {
